...
default:
	...
	-B "$(OUTPUT_PATH)" \
	-G "Ninja" \
	-DTOOLCHAIN_PREFIX="C:/ARM-GCC" \
	-DCMAKE_TOOLCHAIN_FILE="./cmake/arm-none-eabi.cmake" \
	-DNRF5_SDK_PATH="G:/_business/_nrf_SDK/17.0.2_d674dde"
...
ifneq (,$(filter Windows%,$(OS)))
	astyle --project="..\.astylerc" -r "src\**.c,**.h" "inc\**.c,**.h"
else
	astyle --project=".astylerc" -r module/**.c,**.h bluetooth/**.c,**.h
endif
